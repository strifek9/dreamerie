...
await writeFile(new URL('cards.ts', dataDirectory), `// Generated by scripts/create-placeholder-artwork.mjs.\nimport type { Card } from '../game/types.ts'\n\nexport const cards: readonly Card[] = ${JSON.stringify(cards, null, 2)}\n`)
console.log(`Created ${cards.length} distinct SVG fixtures and card metadata.`)
